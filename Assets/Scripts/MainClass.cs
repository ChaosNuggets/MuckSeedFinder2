...
public class MainClass : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Debug.Log(heightMap.CoordToHeightFast(343.5f, -60.2f)); // Should print 5.6 - 3.6
        Debug.Log(heightMap.CoordToHeightPrecise(343.5f, -60.2f)); // Should print 5.6 - 3.6
        Debug.Log(heightMap.CoordToHeightFast(-478.1f, -1102.4f)); // Should print 0
        Debug.Log(heightMap.CoordToHeightPrecise(-478.1f, -1102.4f)); // Should print 0
        Debug.Log(heightMap.CoordToHeightFast(-427.6f, -981.8f)); // Should print 7.2 - 3.6
        Debug.Log(heightMap.CoordToHeightPrecise(-427.6f, -981.8f)); // Should print 7.2 - 3.6
        Debug.Log(heightMap.CoordToHeightFast(-17.3f, 5.5f)); // Should print 31.5 - 3.6
